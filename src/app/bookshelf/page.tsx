...
export default function BookshelfPage() {
  return (
    <div>
      <h1 className="text-2xl font-semibold tracking-tight mb-4">Bookshelf</h1>
      ...
      <h2 className="text-xl font-semibold tracking-tight mb-4">Non-fiction</h2>
      <p className="text-neutral-700 mb-4">
      ...
      <h2 className="text-xl font-semibold tracking-tight mb-4">Fiction</h2>
      <p className="text-neutral-700 mb-4">
