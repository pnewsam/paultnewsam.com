    ...
    >
      ...
      <div className="pr-4">
        <div className="flex items-center gap-1 justify-between">
          <h4 className="text-stone-800 text-lg font-medium tracking-tight">
            {title}
          </h4>
        ...
        {companyHref ? (
          <a href={companyHref}>
            <h5 className="inline-block text-stone-800 text-lg font-medium tracking-tight mb-2 group-hover:text-blue-500 transition">
              {company}
            </h5>
          </a>
        ) : (
          <h5 className="inline-block text-stone-800 text-lg font-medium tracking-tight mb-2">
            {company}
          </h5>
        )}
