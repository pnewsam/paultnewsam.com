...
export const MySkills = () => (
  <div id="skills">
    <h3 className="text-2xl text-stone-700 font-semibold mb-4">My Skills</h3>

    <p className="text-lg text-stone-500 mb-2">
      My primary skills are in frontend space.
    </p>

    <p className="text-lg text-stone-500 mb-2">I also have</p>
    ...
    <p className="text-lg text-stone-500 mb-4"></p>
